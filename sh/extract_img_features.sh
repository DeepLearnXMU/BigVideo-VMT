...
python3 scripts/get_img_feat.py --dataset testcoco --model resnet50 --path /home/sata/kly/fairseq_mmt/data/flickr30k/ --save /home/sata/kly/fairseq_mmt/img_feature/
