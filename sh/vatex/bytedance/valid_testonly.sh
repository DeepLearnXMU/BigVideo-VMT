...
--beam 5  \
--batch-size  128  \
--lenpen $length_penalty  | tee $local_output_dir/$checkpoint.$length_length_penalty.gen-$who.log

echo "move to $checkpoint_dir/$checkpoint.$length_length_penalty.gen-$who.log "
hdfs dfs -put $local_output_dir/$checkpoint.$length_length_penalty.gen-$who.log $checkpoint_dir/$checkpoint.$length_length_penalty.gen-$who.log