...
fairseq-train $local_data_dir \
  ...
  --id-type $id_type  \
  --finetune-from-model hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/fairseq_mmt/fairseq_output/xigua+youtube+wmt19/mask0/mask0ed20_fromxigua+youtube+vatex_archvideo_fushion_encoder_one_merge_before_pewln_criCMC_tgtzh_lr7e-4_wu4000_mt4096_me100_seed1_gpu8_wd0.1_dp0.1_vtypeVIT_128_mvlen32_tsuniform_vdp0.0_idtypeoriginal_patience10_length256_b4l1.0/checkpoint_best.pt \
