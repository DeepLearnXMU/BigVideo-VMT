...
name=vatex_${mask}_arch${arch}_cri${cri}_tgt${tgt_lang}_lr${lr}_wu${warmup}_me${max_epoches}_seed${seed}_gpu${gpu_num}_wd${weight_decay}_vtype${video_feat_type}_vlen${max_vid_len}_rp${residual_policy}_ia${ini_alpha}_ctrw${contrastive_weight}_ctrt${contrastive_temperature}

output_dir=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/fairseq_mmt/fairseq_output/vatex_0819/${mask}/doubleCA/${name}
LOGS_DIR=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/fairseq_mmt/fairseq_logs/vatex_0819/${mask}/doubleCA
local_logs_dir=~/fairseq_logs/vatex_0819/${mask}/doubleCA
