...
if [ $video_feat_type == "VIT_cls" or "VIT_patch"  ]; then
        video_feat_dim=768
...
name=vatex_$mask_arch${arch}_cri${cri}_tgt${tgt_lang}_lr${lr}_wu${warmup}_me${max_epoches}_seed${seed}_gpu${gpu_num}_wd${weight_decay}_vtype${video_feat_dim}
