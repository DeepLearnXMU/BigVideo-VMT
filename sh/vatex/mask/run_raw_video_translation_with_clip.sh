...
ini_alpha=0.0
arch=ve_clip_double_cross_att_small
...
output_dir=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/fairseq_mmt/fairseq_output/vatex_0829/${mask}/ve_clip_double_cross_att/${name}
LOGS_DIR=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/fairseq_mmt/fairseq_logs/vatex_0829/${mask}/ve_clip_double_cross_att
local_logs_dir=~/fairseq_logs/vatex_0829/${mask}/ve_clip_double_cross_att
