...
if [ $text_data == "up_2" ]; then
    local_data_dir=/mnt/bd/xigua-youtube-2/data/fairseq_bin/xigua+youtube+wmt19.en-zh.up_2
    video_ids_path=/mnt/bd/xigua-youtube-2/data/xigua+youtube+wmt19/raw_texts/up_2/
    elif [ ${text_data} == "up_5" ]; then
      local_data_dir=/mnt/bd/xigua-youtube-2/data/fairseq_bin/xigua+youtube+wmt19.en-zh.up_5
      video_ids_path=/mnt/bd/xigua-youtube-2/data/xigua+youtube+wmt19/raw_texts/up_5/
fi
