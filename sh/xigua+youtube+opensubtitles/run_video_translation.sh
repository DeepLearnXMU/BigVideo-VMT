...
if [ $text_data == "up_1" ]; then
    local_data_dir=/mnt/bd/xigua-youtube-2/data/fairseq_bin/xigua+youtube+opensubtitles.en-zh.up_1
    video_ids_path=/mnt/bd/xigua-youtube-2/data/xigua+youtube+opensubtitles/raw_texts/up_1/
    elif [ ${text_data} == "up_2" ]; then
      local_data_dir=/mnt/bd/xigua-youtube-2/data/fairseq_bin/xigua+youtube+opensubtitles.en-zh.up_2
      video_ids_path=/mnt/bd/xigua-youtube-2/data/xigua+youtube+opensubtitles/raw_texts/up_2/
fi
...
output_dir=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/fairseq_mmt/fairseq_output/xigua+youtube+opensubtitles/${mask}/${name}
LOGS_DIR=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/fairseq_mmt/fairseq_logs/xigua+youtube+opensubtitles/${mask}/
local_logs_dir=~/fairseq_logs/xigua+youtube+opensubtitles/${mask}/
