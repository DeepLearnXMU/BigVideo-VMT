...
if [ $text_data == "original_share" ]; then
    local_data_dir=/mnt/bn/luyang/kangliyan/data/fairseq_bin/xigua+youtube.en-zh.original_share
fi
...
output_dir=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/fairseq_mmt/fairseq_output/xigua+youtube/${mask}/${name}
LOGS_DIR=hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/fairseq_mmt/fairseq_logs/xigua+youtube/${mask}
local_logs_dir=~/fairseq_logs/xigua+youtube/${mask}
