...
name=${mask}_arch${arch}_cri${cri}_tgt${tgt_lang}_lr${lr}_wu${warmup}_seed${seed}_gpu${gpu_num}_wd${weight_decay}_vtype${video_feat_type}_rp${residual_policy}_ia${ini_alpha}_patience${patience}
