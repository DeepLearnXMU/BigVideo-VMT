...
hdfs dfs -get hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/data/fairseq_bin/vatex.en-zh.fromxigua+youtube+vatex ~/data/fairseq_bin/
...
hdfs dfs -get hdfs://haruna/home/byte_arnold_hl_mlnlc/user/kangliyan/data/xigua+youtube+wmt19/wmt19_vids ~/
