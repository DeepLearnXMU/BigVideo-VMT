...
class VideoLanguageDatasetFromNp(FairseqDataset):
    """
    ...
    Args:
        ...
        videos (VideoDataset): list for video dataset
    ...
    def __getitem__(self, index):
        ...
        video_item,padding_item = self.video_dataset[index]  # list for video data
