...
@register_model("ve_clip_double_cross_att")
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.layers.extend(
            [
                self.build_decoder_layer(args, no_encoder_attn, video_att_before=args.video_att_before)
...
@register_model_architecture('ve_clip_double_cross_att', 've_clip_double_cross_att_base')
...
@register_model_architecture('ve_clip_double_cross_att', 've_clip_double_cross_att_pewoln')
def ve_clip_double_cross_att_pewoln(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 512)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
...
@register_model_architecture('ve_clip_double_cross_att', 've_clip_double_cross_att_be_pewln')
def ve_clip_double_cross_att_be_pewln(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 512)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
...
@register_model_architecture('ve_clip_double_cross_att', 've_clip_double_cross_att_be_pewoln')
def ve_clip_double_cross_att_be_pewoln(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 512)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
