import torch
import logging
from fairseq.models.video.video_swin.swin_transformer import SwinTransformer3D
from fairseq.models.video.video_swin.config import Config
...
def get_swin_model(args):
    if int(args.img_res) == 384:
        ...
        config_path = './video_swin/swin_%s_384_patch244_window81212_kinetics%s_22k.py'%(args.vidswin_size, args.kinetics)
        ...
        config_path = './video_swin/swin_%s_patch244_window877_kinetics%s_22k.py'%(args.vidswin_size, args.kinetics)
        model_path = args.videoswin_path
    if args.pretrained_2d:
        config_path = './video_swin/swin_base_patch244_window877_kinetics400_22k.py'
        model_path = args.videoswin_path
