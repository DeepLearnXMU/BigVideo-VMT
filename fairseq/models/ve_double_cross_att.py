...
@register_model("ve_double_cross_att")
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features_scriptable(
        ...
        # video_h = self.video_forward_embedding(video_h, None)
...
@register_model_architecture('ve_double_cross_att', 've_double_cross_att_base')
...
@register_model_architecture('ve_double_cross_att', 've_double_cross_att_pewoln')
def ve_double_cross_att_pewoln(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 512)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
...
@register_model_architecture('ve_double_cross_att', 've_double_cross_att_be_pewln')
def ve_double_cross_att_be_pewln(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 512)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
