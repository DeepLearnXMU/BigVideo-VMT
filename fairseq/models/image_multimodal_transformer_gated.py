...
@register_model("image_multimodal_transformer_gated")
...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        self.denses.extend([nn.Linear(i, embed_dim) for i in args.image_feat_dim ])
    ...
    def fuse_img_feat(self, text, idx, image, image_mask, text_mask):
        ...
        b, t, c = text.shape
        v_repr = image.view(b, 1, self.args.image_feat_dim[idx])  # B, 1, img_dim
