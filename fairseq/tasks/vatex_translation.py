...
def load_langpair_dataset(
    ...
    video_dataset = VideoDataset(video_feat_path, video_ids_path,max_vid_len,split)
...
@register_task("vatex_translation")
class VatexTranslationTask(LegacyFairseqTask):
    """
