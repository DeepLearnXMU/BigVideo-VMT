...
def load_VideoLanguageDatasetFromNp(
        args,
        data_path,
        split,
        src,
    ...
    return VideoLanguageDatasetFromNp(
        src_dataset,
        src_dataset.sizes,
        src_dict,
        video_dataset,
...
class RawVideoTranslationFromNpTask(LegacyFairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--sampling-frames', type=float, default=0.0)
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = load_VideoLanguageDatasetFromNp(
            self.args,
            data_path,
            split,
            src,
